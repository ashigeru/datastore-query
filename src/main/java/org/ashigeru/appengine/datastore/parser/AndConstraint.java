...
public final class AndConstraint extends Constraint {
    ...
    /**
     * 指定のビジタを受け入れ、
     * {@link Visitor#visitAndConstraint(AndConstraint,Object) visitAndConstraint(this, context)}
     * に処理を委譲する。
     */
    @Override
    public <R, C, E extends Throwable> R accept(
        ...
        return visitor.visitAndConstraint(this, context);
    }

    @Override
    public String toString() {
        return java.text.MessageFormat.format(
            "AndConstraint'{'left:{0}, right:{1}'}'",
            left,
            right
            );
    }
